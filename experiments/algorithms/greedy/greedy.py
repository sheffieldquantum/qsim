...
def greedy():
    ...
    for gen in range(1, gens+1):
        ...
        if best_neighbour_error < current_error:
            ...
            current_error_percent = 100 * (current_error / suzuki_error)
            print('New best: error: {} percent: {} solution: {})'.format(current_error, current_error_percent, current))
        elif best_neighbour_error >= current_error:
            best_neighbour_percent = 100 * (best_neighbour_error / suzuki_error)
            print('Best result: error: {} percent: {} solution: {}'.format(best_neighbour_error, best_neighbour_percent,
                                                                            best_neighbour))
            return
